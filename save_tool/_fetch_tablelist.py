...
def fetch_text(url):
    ...
    t = re.sub(r'\n\s*\n+', '\n', t)
    return t
t = fetch_text('https://nenkai.github.io/relink-modding/tables/table_list/')
open(r'C:\Users\MikeT\Downloads\1.8.5\save_tool\_table_list.txt','w',encoding='utf-8').write(t)
print('table_list saved', len(t))
for line in t.splitlines():
    low = line.lower()
    if 'skill' in low or 'gem' in low or 'sigil' in low:
